...
##export CI_OPT_CI_SCRIPT="https://github.com/ci-and-cd/maven-build/raw/v0.3.2/src/main/ci-script/lib_ci.sh"
...
if [ -z "${CI_OPT_CI_SCRIPT}" ]; then CI_OPT_CI_SCRIPT="https://github.com/ci-and-cd/maven-build/raw/v0.3.2/src/main/ci-script/lib_ci.sh"; fi
...
if [ -z "${CI_OPT_MAVEN_BUILD_REPO}" ]; then CI_OPT_MAVEN_BUILD_REPO="https://github.com/ci-and-cd/maven-build/raw/v0.3.2"; fi
if [ -z "${CI_OPT_ORIGIN_REPO_SLUG}" ]; then CI_OPT_ORIGIN_REPO_SLUG="cloud-ready/spring-boot-jackson2"; fi
